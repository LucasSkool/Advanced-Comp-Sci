public class DecompositionDemo {
    ...
    public static void bigMethodToDecompose() {
        ...
        if (validateEqualLength(hours, steps, activeMinutes) == true) {
    ...
    public static boolean validateEqualLength(int[] hours, int[] steps, int[] activeMinutes) {
        int n = hours.length;
    ...
    public double calculateTotalSteps() */
    }
