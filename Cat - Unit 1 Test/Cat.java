public class Cat {  //made "Public" --> "public", made "Cats" --> "Cat"
	...
	public Cat(String name, String breed) {  //made "cat" --> "Cat", added "breed" parameter because it is later mentioned
	...
	public boolean getIsHungry(){  // void --> boolean because isHungry is a boolean, capitalized 'I' and 'H' in "ishungry"
		return isHungry;
	}
	...
	public boolean equals(Cat other) {
		return this.name.equals(other.name) && this.breed.equals(other.breed) // == --> equals() because are comparing Strings
			&& this.livesRemaining == other.livesRemaining;  // = --> == because we are comparing, not setting equal
	}

	public String toString() {
		return (name + " is of breed " + breed + " and has " + livesRemaining + " lives remaining."); //toString()'s are return methods, System.out.println() --> return
	}
}