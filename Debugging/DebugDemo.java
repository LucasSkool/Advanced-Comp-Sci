public class DebugDemo {
    ...
    private static void runDivideByZeroScenario() {
        ...
        String[] names = new String[] {"This", "That", "There"}; //I changed these because I got mad
        int totalLength = 0;
        int count = 0;
        for (int i = 0; i < names.length; i++) {
            totalLength += names[i].length(); //hghjhgfghjhgfghjjh
    ...
    public static int[] parseNumbers(String csv) {
        ...
        for (int i = 0; i < parts.length; i++) {
            ...
            try {
                ...
                System.out.println("Something was inconvinient, so I didn't do it.");
            }
        }
        return result;
    }
    ...
    public static int fib(int n) { //n = 7 = error
        int a = 0; //2 before
        int b = 2; //1 before
        if (n == 0) {
            return a;
