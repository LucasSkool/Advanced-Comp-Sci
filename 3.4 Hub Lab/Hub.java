...
public class Hub {
    ...
    public Student loginStudent(String username, String password) {
        ...
        if (!students[index].password.equals(password)) {
            throw new SecurityException("Wrong password."); // ENDED HERE LAST TIME
        }
    ...
    // I ADDED THIS BECAUSE i don't think there is any other way to make the student array null???
